  ...
  return (
    <div>
      ...
      <ModernModal
        ...
        isDraggable={true}
        header={<div>Fullscreen Without Content</div>}
      ></ModernModal>
      <ModernModal
        size="xlarge"
        ...
        isDraggable={true}
        header={<div>XLarge Without Content</div>}
      ></ModernModal>
      <ModernModal
        size="large"
        ...
        isDraggable={true}
        header={<div>Large Without Content</div>}
      ></ModernModal>
      <ModernModal
        size="medium"
        ...
        isDraggable={true}
        header={<div>Medium Without Content</div>}
      ></ModernModal>
      <ModernModal
        size="small"
        ...
        isDraggable={true}
        header={<div>Small Without Content</div>}
      ></ModernModal>
      <ModernModal
        size="xsmall"
